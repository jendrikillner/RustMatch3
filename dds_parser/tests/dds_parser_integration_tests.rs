...
fn load_and_create_white_4x4_mips_bc3() {
    ...
    // load the test texture
    let file = std::fs::File::open(
        "C:/jendrik/projects/rustmatch3/dds_parser/tests/data/paintnet/white_4x4_bc3_mips.dds",
    );
    let mut data = Vec::new();
    let _file_read_result = file.unwrap().read_to_end(&mut data);
...
fn load_and_create_white_4x4_bc3() {
    ...
    // load the test texture
    let file = std::fs::File::open(
        "C:/jendrik/projects/rustmatch3/dds_parser/tests/data/paintnet/white_4x4_bc3.dds",
    );
    let mut data = Vec::new();
    let _file_read_result = file.unwrap().read_to_end(&mut data);
